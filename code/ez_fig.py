...
plot_nls1_distribution(xgb_dens, ax[0,0], d, p, label_loc = 'upper left')
...
plot_nls1_distribution(xgb_dens, ax[0,1], d, p, label_loc = 'upper left')
...
plot_nls1_distribution(xgb_dens, ax[1,0], d, p, label_loc = 'upper left')
